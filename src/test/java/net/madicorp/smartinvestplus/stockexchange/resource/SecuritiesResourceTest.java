...
public class SecuritiesResourceTest {
    ...
    public void should_return_brvm_securities() throws Exception {
        ...
        ResponseAssertion.assertThat(actual)
                         ...
                         .contains("$[0].links[1].href", "/api/stock-exchanges/brvm/securities/SEC1/close-rates");
    }
    ...
    public void should_return_sec_1_security() throws Exception {
        // GIVEN
        when(mockRepo.findSecurity("BRVM", "SEC1")).thenReturn(StockExchangeMockData.security());

        // WHEN
        Response actual = rule.get("/api/stock-exchanges/brvm/securities/sec1");
    ...
    public void should_return_sec_1_close_rates() throws Exception {
        ...
        when(mockCloseRateService.getOneMonthToDateCloseRates("BRVM", "SEC1", LocalDate.now()))
            .thenReturn(closeRates);

        // WHEN
        Response actual = rule.get("/api/stock-exchanges/brvm/securities/sec1/close-rates");
    ...
    public void should_create_a_division() throws Exception {
        ...
        Response actual = rule.put("/api/stock-exchanges/brvm/securities/sec1/divisions",
                                   Entity.json("{" +
                                               "    \"rate\": 0.4," +
                                               "    \"date\": \"" + july122016 + "\"" +
                                               "}"));
        ...
        ResponseAssertion.assertThat(actual)
                         .created()
                         .location("/api/stock-exchanges/brvm/securities/sec1/divisions/20160712")
    ...
    public void should_return_bad_request_if_division_exists() throws Exception {
        ...
        when(mockRepo.findSecurity("BRVM", "SEC1")).thenReturn(security);
    ...
    public void should_return_404_when_security_is_not_found() throws Exception {
        // GIVEN
        when(mockRepo.findSecurity("BRVM", "SEC1")).thenReturn(null);
    ...
    public void should_return_200_if_it_can_get_division_in_security() throws Exception {
        ...
        when(mockRepo.getDivision("BRVM", "SEC1", july142016)).thenReturn(Optional.of(division(july142016, .4)));
        String july142016String = july142016.format(DateTimeFormatter.ISO_DATE);

        // WHEN
        Response actual = rule.get("/api/stock-exchanges/brvm/securities/sec1/divisions/" +
    ...
    public void should_return_404_if_it_can_get_holiday_in_stock_exchange() throws Exception {
        // GIVEN
        LocalDate july142016 = LocalDate.of(2016, Month.JULY, 14);
        when(mockRepo.getDivision("BRVM", "SEC1", july142016)).thenReturn(Optional.empty());
